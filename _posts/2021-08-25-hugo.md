...
I am omega amateur with making websites. I can write, I can type, my Markdown
game is strong, but I let software do their thing to output nice html pages
(or other markup languages). I know enough html from school to edit headers
and footers, and finding a solution that works fast and hassle-free is
important.
